...
onready var lbl_speed = $ui/hb_ui/vbc_movement/speed
onready var lbl_distance = $ui/hb_ui/vbc_movement/distance
onready var lbl_time = $ui/hb_ui/vbc_control/time
onready var lbl_fuel = $ui/hb_ui/vbc_control/fuel
